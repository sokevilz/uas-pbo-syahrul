...
<head>
	<title>Dashboard | pemesanan hotel unida  </title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="?p=home"><img src="assets/img/unida inn.jng" alt="unida inn" class="img-responsive logo"></a>
			</div>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2022 <a href="#" target="_blank">uas syahrul mubarok</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
